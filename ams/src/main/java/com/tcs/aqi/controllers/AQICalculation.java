	...
	static double pm10,pm2dot5,no2,o3,co,so2,nh3,pb;
	 ...
	 public String calculate (Pollutant emp , ModelMap model){
		...
		_pb = new HashMap<>();
			...
			System.out.println(pm10+" "+pm2dot5+" "+no2+" "+o3+" "+co+" "+" "+so2+" "+nh3+" "+pb+"AQI: "+AQI);
		return "Datadisplay";
	 }
	 static void takeInput (Pollutant emp)
		...
		static void indexCalculation () throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException
		{
