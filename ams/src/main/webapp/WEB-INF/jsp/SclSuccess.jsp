	...
	<div class="bg">
		<nav class="navbar navbar-toggleable-md navbar-inverse"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a href="#"><button class="btn-change7" type="submit"
						disabled="disabled">${user.username}</button></a> <a href="adminInput"><button
						class="btn-change7" type="submit">Menu</button></a> <a href="logout"><button
						class="btn-change8" type="button" data-target="#loginModal"
		...
		<div class="main-name">
			...
			<div class="buttons">
				<a href="addscl"><button class="error-button">Add New
						Data</button></a>
