              ...
              <div class="registration-table">
                  ...
                  <form:form method="post" action = "addUser">
                      <table>
                          <tr>
                              <td>Full name:</td>
                              <td><form:input type="text" name="full-name" placeholder="Full Name" path = "fName"/></td>
                          </tr>
                          
                          <tr>
                              <td>E-mail:</td>
                              <td><form:input type="email" name="user-email" placeholder="E-mail Address" path = "email"/></td>
                          </tr>
                          
                           <tr>
                              <td>Password:</td>
                              <td><form:input type="password" name="user-password" placeholder="Password" path = "password"/></td>
                          </tr>
                          
                          <tr>
                              <td>Street Address</td>
                               <td><form:input type="text" name="location" placeholder="Location" path = "location"/></td>
                          </tr>
                          <tr>
                              <td>City:</td>
                              <td>
                          ...
                          <tr>
                              <td>State:</td>
                              <td>
                                  <form:input type="text" name="state" placeholder="State" path = "state"/>
                              </td>
                          </tr>
